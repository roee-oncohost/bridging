...
def alter_scanner_files_MAD_bridging(text_path, workbook_path, params_path, output_path, sample_type='Streck'): #, streck_wells_list=[]):
    """
    ...
    samples_to_alter  = workbook_df[workbook_df[WORKBOOK_SAMPLE_MATRIX].isin([STRECK_VALUE])]
...
if __name__ == '__main__':
    ...
    i = 4    # i = 1
    # test_aggregation_only(f'data/plates/MAD_bridging/original_with_altered_workbooks/OH2025_05{i}',
    #                     f'data/plates/MAD_bridging/original_with_altered_workbooks/OH2025_05{i}/OH2025_05{i} Workbook.xlsx',
    #                     'data/conversion_coefficients/MAD_median_streck_coefficients.json',
    #                     f'data/plates/MAD_bridging/aggregation_testing/OH2025_05{i}_normalized',
    #                     'base'
    ...
    # i = 2
        alter_scanner_files_MAD_bridging(f'data/plates/MAD_bridging/original/OH2025_05{i}',
                            f'data/plates/MAD_bridging/original/OH2025_05{i}/OH2025_05{i} Workbook.xlsx',
                            'data/conversion_coefficients/MAD_median_streck_coefficients.json',
                            f'data/plates/MAD_bridging/bridged_plates/OH2025_05{i}_fast',
                            'Streck'
                            # ['A6', 'B4', 'C1', 'C5', 'D3', 'E5', 'F1', 'H2', 'H4']
        )
